...
alter table klasy
    add column wychowawca integer references nauczyciele (osoba) unique;
alter table klasy
...
create type kategoriaOceny as enum ('sprawdzian', 'kartkówka', 'odpowiedź', 'zadanie', 'aktywność', 'inne');
create table oceny
(
